      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-8 text-center">
        {stats.map((stat) => (
          <div key={stat.label}>
            ...
            <div className="font-smallcaps text-[#bfa88a] text-xs sm:text-sm tracking-[0.22em] uppercase">
              {stat.label}
            </div>
          </div>
        ))}
    ...
    <section className="bg-[#EBE9E3] py-24 px-6">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          ...
          <div className="space-y-6 mb-12">
            {philosophy.features.map((feature) => (
              <div key={feature.title} className="flex gap-5">
                ...
                <div className="w-5 h-px bg-[#bfa88a] mt-3.5 flex-shrink-0" />
                <div>
        ...
        <div className="relative">
          <div className="absolute bottom-[-20px] right-[-20px] w-4/5 h-4/5 bg-[#bfa88a]/20 z-0" />
          <img
