    ...
    <Link href={`/preferred-partners/${partner.id}`}>
      <div className="group flex flex-col bg-[#FAF8F5] border border-[#BFAF8A]/30 hover:border-[#BFAF8A] transition-all duration-300 cursor-pointer h-full">
        ...
        <div className="flex flex-col flex-1 p-6">
          {/* Partner name */}
          <h3 className="text-xl text-[#384959] mb-1 leading-tight" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 500 }}>
            {partner.name}
          </h3>
    ...
    <div className="bg-[#EDEAE4] min-h-screen">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl md:text-4xl text-[#384959] uppercase tracking-wider mb-6" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 500 }}>
      ...
      <section className="pb-20 px-6">
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-2xl text-[#384959] uppercase tracking-widest whitespace-nowrap" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 500 }}>
              {activeCategory === "All"
                ? "Preferred Partners"
      ...
      <section className="py-20 px-6 bg-[#FAF8F5]">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 mb-10">
            ...
            <h2 className="text-xl md:text-2xl text-[#384959] uppercase tracking-widest text-center" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 500 }}>
              ...
              <Link key={prop.name} href={`/preferred-partners/${prop.partnerId}`}>
                <div className="group relative overflow-hidden cursor-pointer">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <h3 className="text-white text-lg leading-tight mb-0.5" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 500 }}>
                      {prop.name}
                    </h3>
      ...
      <section className="relative h-[50vh] min-h-[380px] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl text-white uppercase tracking-wider mb-4" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 500 }}>
            {partnersCta.heading}
          </h2>
