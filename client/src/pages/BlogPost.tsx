  ...
  return (
    <PageLayout>
      ...
      <div className="max-w-[720px] mx-auto px-6 pb-12">
        <div className="flex items-center justify-between border-t border-[#edeac4] pt-8">
          ...
          <button
            ...
            className="flex items-center gap-2 border border-[#edeac4] px-4 py-2 text-[#2F2F2F]/60 text-sm hover:border-[#bfa88a] hover:text-[#bfa88a] transition-colors"
          >
      ...
      <div className="max-w-[720px] mx-auto px-6 pb-20">
        <div className="bg-[#f5f0e6] px-10 py-12 text-center">
          <p
