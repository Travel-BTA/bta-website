  ...
  return (
    ...
    <section className="hidden lg:flex relative h-[42vh] min-h-[320px] max-h-[480px] items-end pb-10 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-14">
        ...
        <p className="text-white/75 text-xs tracking-[0.25em] uppercase mb-3" style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontStyle: "normal" , textTransform: "uppercase" }}>
          {h.title}
        </p>
