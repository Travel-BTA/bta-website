...
export default function Journal() {
  ...
  return (
    <PageLayout hideCta={false}>
      ...
      {/* ── Filter Bar ──────────────────────────────────────────────────── */}
      <div className="bg-[#F5F0EA] border-b border-[#edeac4] px-6 py-4">
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 pb-16">
                <button
                  ...
                  disabled={page === 1}
                  className="border border-[#edeac4] px-6 py-2.5 text-[#2F2F2F]/50 text-xs tracking-[0.14em] uppercase hover:border-[#bfa88a] hover:text-[#bfa88a] transition-colors disabled:opacity-30"
                >
                  Previous
                </button>
                  ...
                  <button
                    ...
                    className={`w-10 h-10 text-xs tracking-[0.14em] transition-colors ${
                      page === n
                        ...
                        : "border border-[#edeac4] text-[#2F2F2F]/50 hover:border-[#bfa88a] hover:text-[#bfa88a]"
                    }`}
                  >
                    {n}
                  </button>
