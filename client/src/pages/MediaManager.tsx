...
export default function MediaManager() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6]">
      {/* Header */}
      <header className="bg-white border-b border-[#edeac4] sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="w-px h-5 bg-[#edeac4]" />
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div
          ...
          className={`border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-all mb-8 ${
            dragOver
              ...
              : "border-[#edeac4] bg-white hover:border-[#bfa88a] hover:bg-[#bfa88a]/5"
          }`}
        >
        ...
        {/* Upload Progress */}
        {uploading.length > 0 && (
          <div className="bg-white rounded-xl border border-[#edeac4] p-4 mb-8 space-y-2">
            ...
            {uploading.map((u, i) => (
              <div key={i} className="flex items-center gap-3">
                <div className="flex-1">
                  ...
                  <div className="h-1.5 bg-[#edeac4] rounded-full overflow-hidden">
                    <div
        ...
        <div className="flex items-center gap-4 mb-6">
          <input
            ...
            className="border border-[#edeac4] rounded-lg px-4 py-2 text-sm w-72 focus:outline-none focus:border-[#bfa88a] bg-white"
          />
        ...
        {isLoading ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {Array.from({ length: 10 }).map((_, i) => (
              <div key={i} className="bg-white rounded-xl border border-[#edeac4] aspect-square animate-pulse" />
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {filteredFiles?.map((file: any) => (
              <div
                key={file.id}
                className="bg-white rounded-xl border border-[#edeac4] overflow-hidden group hover:shadow-md transition-shadow"
              >
                {/* Preview */}
