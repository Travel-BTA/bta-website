      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div
          ...
          className={`border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-all mb-8 ${
            dragOver
              ...
              : "border-[#edeac4] bg-white hover:border-[#bfaf8a] hover:bg-[#bfaf8a]/5"
          }`}
        >
        ...
        <div className="flex items-center gap-4 mb-6">
          <input
            ...
            className="border border-[#edeac4] rounded-lg px-4 py-2 text-sm w-72 focus:outline-none focus:border-[#bfaf8a] bg-white"
          />
